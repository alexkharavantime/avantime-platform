...
- `S3DocumentStorage` зафиксирован только как будущий контракт и в этой итерации не реализован.
...
- реализовать S3-адаптер и перенести production-объекты через существующий контракт;
