...
export function KnowledgeList() {
  return (
    <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
      <div className="flex items-center justify-between gap-4 border-b border-slate-200 px-5 py-4"><div><h2 className="font-black text-slate-950">Последние документы</h2><p className="text-sm text-slate-500">Демонстрационные данные MVP, не фактическая статистика</p></div><Link href="/dashboard/knowledge" className="rounded-xl bg-blue-600 px-4 py-2 text-sm font-bold text-white hover:bg-blue-700">Открыть раздел</Link></div>
